...
<body>
    ...
    <a href="http://localhost:8080/restauranteWeb2/chamadaservlet?acao=cadastraproduto"><button>Cadastrar produtos</button></a>
    <br><br>
    ...
    <br><br>
    <a href="chamadaservlet?acao=simularvendas"><button type="submit" id="button2">Simular venda</button></a>
    <br><br>
			...
			<tbody>
				<c:forEach var="produto" items="${produtos}">
					<tr>
						...
						<td><a href="chamadaservlet?acao=alteraproduto&idProduto=${produto.idProduto}">Alterar</a></td>
						<td><a href="chamadaservlet?acao=exclui&idProduto=${produto.idProduto}">Excluir</a></td>
					</tr>
				</c:forEach>		
			</tbody>
		</table>
