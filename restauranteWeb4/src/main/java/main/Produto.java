...
public class Produto {
    ...
    public Produto(String nomeProduto, double precoVenda, double precoCusto, double probabilidadeVenda, int quantidadeVendida) {
    ...
    public Produto(int idProduto, String nomeProduto, double precoVenda, double precoCusto, double probabilidadeVenda, int quantidadeVendida) {
